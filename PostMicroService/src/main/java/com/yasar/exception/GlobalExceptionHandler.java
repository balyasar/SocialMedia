...
import static com.yasar.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerSatisException(PostException postException) {
        return new ResponseEntity<>(createMessage(postException.getErrorType(), postException), postException.getErrorType().getHttpStatus());
    }
